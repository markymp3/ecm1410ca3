...
* @throws IllegalNameException If the name already exists in the platform. * @throws InvalidNameException If the name is null, empty, has more than 30 * characters, or has white spaces.
...
* length).
7
* @throws IDNotRecognisedException If the ID does not match to any race in the * system.
*/
...
@param type
cannot be null.
The type of the stage. This is used to determine the
...
* @throws InvalidNameException If the new name is null, empty, has more than 30.
*
...
int addStageToRace(int raceId, String stageName, String description, double length, LocalDateTime
    startTime, StageType type) throws IDNotRecognisedException, IllegalNameException, InvalidNameException, InvalidLengthException;
/**
...
*
* @param raceId The ID of the race being queried.
* @return The list of stage IDs ordered (from first to last) by their sequence in the * race.
...
* @throws IDNotRecognisedException If the ID does not match to any stage in the * system.
*/
 ...
 *
 *
The ID of the stage to which the climb segment is
being added.
The kilometre location where the climb finishes within
the stage.
The category of the climb - {@link SegmentType#C4},
...
* @throws IDNotRecognisedException If the ID does not match to any stage in * the system.
* @throws InvalidLocationException If the location is out of bounds of the * stage length.
* @throws InvalidStageStateException If the stage is "waiting for results". * @throws InvalidStageTypeException Time-trial stages cannot contain any
* segment.
*/
...
* @throws IDNotRecognisedException If the ID does not match to any segment in * the system.
* @throws InvalidStageStateException If the stage is "waiting for results". */
...
* @throws IllegalNameException If the name already exists in the platform.
* @throws InvalidNameException If the new name is null, empty, has more than * 30 characters.
*/
...
* @throws IDNotRecognisedException If the ID does not match to any team in the * system.
*/
...
void registerRiderResultsInStage(int stageId, int riderId, LocalTime... checkpoints) throws
